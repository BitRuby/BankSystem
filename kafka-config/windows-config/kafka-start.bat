...
start bin\windows\kafka-console-consumer.bat --topic make-transfer --bootstrap-server localhost:9092 --from-beginning
start bin\windows\kafka-console-consumer.bat --topic status-sender --bootstrap-server localhost:9092 --from-beginning
